...
<div className="main-container">
  ...
  <div className="info"><h4>Welcome to my portfolio!<br/>
    <br/>
    Here are my projects which I did during a 12 week bootcamp in the spring of 2018. This page is built in React, and the other projects are a mixture of HTML, CSS, SASS, JavaScript and React. <br/>
<br/>
